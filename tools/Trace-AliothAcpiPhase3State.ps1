...
$targets = @(
    ...
    [pscustomobject]@{ Name = "IPC0 native"; AcpiId = "QCOM050E"; ExpectedService = "qcipcrtr" },
    [pscustomobject]@{ Name = "IPC0 kona"; AcpiId = "QCOM250E"; ExpectedService = "qcipcrtr" },
    [pscustomobject]@{ Name = "SSDD native"; AcpiId = "QCOM0522"; ExpectedService = "qcsubsys" },
    [pscustomobject]@{ Name = "SSDD kona"; AcpiId = "QCOM2522"; ExpectedService = "qcsubsys" },
