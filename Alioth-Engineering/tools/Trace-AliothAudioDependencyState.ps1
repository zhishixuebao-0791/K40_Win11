...
$targets = @(
    ...
    [pscustomobject]@{ Name = "CDSP 8280"; Native = "QCOM06B0"; Alias = "QCOM06B0"; ExpectedService = "qcsubsys"; Role = "Surface 8280 CDSP qcsubsys candidate" },
    [pscustomobject]@{ Name = "SPSS 8280"; Native = "QCOM068D"; Alias = "QCOM068D"; ExpectedService = "qcsubsys"; Role = "Surface 8280 SPSS qcsubsys candidate" },
    [pscustomobject]@{ Name = "SCSS 8280"; Native = "QCOM061F"; Alias = "QCOM061F"; ExpectedService = "qcsubsys"; Role = "Surface 8280 SCSS qcsubsys candidate" },
